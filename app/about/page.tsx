                      ...
                      {educations.map((item, idx) => {
                        return (
                          <li className="mb-10 ms-4" key={idx}>
                            <div className="absolute w-3 h-3 rounded-full mt-1.5 -start-1.5 border border-gray-900 bg-gray-900 dark:border-gray-200 dark:bg-gray-200"></div>
                            <time className="mb-1 text-sm font-normal leading-none text-gray-700 dark:text-gray-300">
                              {item.duration}
                            </time>
