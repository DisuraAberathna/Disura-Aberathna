                    ...
                    <main className="relative flex justify-center items-center flex-col overflow-clip">
                        <div className="w-full">
                            ...
                            <section className="md:min-h-screen bg-white dark:bg-gray-900">
                                <div className="pt-8 pb-32 md:pb-40 flex flex-col justify-evenly items-center">
                                    <motion.div
                                        variants={fadeIn("down", 0)}
                                        initial="hidden"
                                        whileInView={"show"}
                                        viewport={{once: false, amount: 0.4}}
                                        className="w-full lg:w-[70%] md:px-10 py-10"
                                    >
                                        <iframe
                                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d37802.62174455454!2d80.60518185155247!3d7.294587402110213!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae366266498acd3%3A0x411a3818a1e03c35!2sKandy!5e1!3m2!1sen!2slk!4v1731157169278!5m2!1sen!2slk"
                                            referrerPolicy="no-referrer-when-downgrade"
                                            className="w-full h-[500px]"
                                        >
                                        </iframe>
                                    </motion.div>
                                    <div className="flex flex-col md:flex-row justify-center gap-x-20 gap-y-5 px-6">
