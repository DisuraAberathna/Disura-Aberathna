...
import {FaFacebook, FaGithub, FaLinkedin, FaWhatsapp, FaYoutube} from "react-icons/fa6";
                ...
                <div className="md:flex md:justify-between items-center">
                    <div className="mb-6 md:mb-0">
                        ...
                        >
                            ...
                            <button
                                type="submit"
                                className="text-white bg-blue-700 flex items-center gap-2 hover:bg-blue-800 focus:ring-2 outline-none focus:ring-blue-500 font-medium rounded-md text-sm md:px-5 px-3 py-1.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                            >
                                Subscribe
                            </button>
                            {" "}
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2 w-80">
                        ...
                        >
                            ...
                            <ul className="text-white font-medium">
                                ...
                                <li className="mb-4">
                                    <a
                                        href="https://github.com/DisuraAberathna"
                                        target="_blank"
                                        className="hover:underline text-sm"
                                    >
                                        GitHub
